...
UENUM(BlueprintType)
enum class ERequestFulVerb : uint8
{
	GET,
	POST,
	PUT,
	//PATCH, /** Added by HerrSergio */ NOT WORKING IN ENGINE!!!
...
UENUM(BlueprintType)
enum class ERequestFulContentType : uint8
{
...
UENUM(BlueprintType)
enum class ERequestFulStatus : uint8
{
